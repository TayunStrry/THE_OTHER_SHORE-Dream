 ...
 */
export function TrySpawnEntity(dimension, typeID, location) {
    try {
 ...
 */
export function RandomFloat(min, max, length = 2) {
 ...
 */
export function TriggerControl(eventType, source, waitTime = 20) {
    /**
     * 触发的事件的唯一标识符键
     *
     * @type {string}
