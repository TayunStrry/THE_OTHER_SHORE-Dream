 ...
 */
function NumberParticleDisplay(anchor: type.LOCATION_AND_DIMENSION, numberToDisplay: number, offset: server.Vector3) {
	// 判断 数值 是否过大
	if (numberToDisplay > 99999) return;
	/**
	 * * 粒子参数
	 */
	const molang = new server.MolangVariableMap();
