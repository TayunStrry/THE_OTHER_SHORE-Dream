 ...
 */
const help = new Map<string, type.LEXICON_INTEL>();
help.set('开发者名单',
	{
		root: ['开发者', '花名册'],
		intel: [
...
const decorating: server.RawMessage[] = [
...
const adrift_default_attack: server.RawMessage = {
	rawtext: [
		{ text: '< 普通攻击 >:\n' },
...
const wasp_default_attack: server.RawMessage = {
	rawtext: [
		{ text: '< 基础属性 >:\n' },
		{ text: '      • [§9 基础血量 §r]: 20\n' },
		{ text: '      • [§9 基础攻击 §r]: 5\n' },
...
const item_mineral: server.RawMessage[] = [
	{ text: '--------------------------------\n\n' },
...
const ore_generate: server.RawMessage = { text: '该材料会在[ 主世界 ]以[ 矿物团簇 ]的形式生成\n\n' };
const ore_make: server.RawMessage = { text: '该材料需要在< 闪长岩桌 >中合成获得\n\n' };
[
...
const magic_crystal_armor: server.RawMessage[] = [
...
const magic_orbs: server.RawMessage[] = [
	{ text: '当玩家装备该物品时\n\n' },
	{ text: '每隔§2 5 §r秒将获得§2 15 §r秒增益效果\n\n' },
