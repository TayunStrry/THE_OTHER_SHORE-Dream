 ...
 * @type {Set<string>}
 */
export const is_mineral: Set<string> = new Set<string>(
	[
		"minecraft:coal_ore",
		"minecraft:iron_ore",
		"minecraft:gold_ore",
 ...
 * @type {Set<string>}
 */
export const is_trees: Set<string> = new Set<string>(
	[
		"minecraft:vine",
		"minecraft:oak_log",
		"minecraft:bee_nest",
 ...
 * @type {Set<string>}
 */
export const is_wood: Set<string> = new Set<string>(
	[
 ...
 */
export const is_crops: Map<string, string | boolean> = new Map<string, string | boolean>(
	[
 ...
 * * 实体属性 - 战斗属性
 */
export const battle_property = new Map<string, type.SET_PROPERTY_PANEL>(
	[
		//* 野蜂机群
 ...
 * * 实体数据 - 名称映射
 */
export const name_mapping = new Map<string, string>(
	[
 ...
 * * 实体数据 - 重置属性
 */
export const reset_battle_data: type.SET_PROPERTY_PANEL = {
 ...
 */
export const offset_show = new Map<string, number>(
	[
 ...
 */
export const chorus_call_role = new Map<string, number>(
	[
 ...
 * @param {number} weight - 选择生成 该实体 的 权重
 */
export const call_healer_role = new Map<string, number>(
	[
 ...
 * @param {number} weight - 选择生成 该实体 的 权重
 */
export const call_fortify_role = new Map<string, number>(
	[
 ...
 */
export const area_legend = new Map<string, number>(
	[
 ...
 * @param {number} weight - 选择生成 该实体 的 权重
 */
export const wasp_cluster_raid = new Map<string, number>(
	[
 ...
 */
export const role_main_hand = new Map<string, number>(
	[
 ...
 * @param {number} weight - 选择生成 该物品 的 权重
 */
export const role_off_hand = new Map<string, number>(
	[
 ...
 * @param {number} weight - 选择生成 该物品 的 权重
 */
export const role_armor_legs = new Map<string, number>(
	[
 ...
 */
export const solidify_output = new Map<string, number>(
	[
		["minecraft:tuff", 1],
		["minecraft:stone", 40],
		["minecraft:basalt", 1],
 ...
 */
export const crops_map = new Map<string, string>(
	[
 ...
 * * 维度类型
 */
export const dimension_map = new Map<string, string>(
	[
 ...
 * * 群系类型
 */
export const biome_map = new Map<string, string>(
	[
 ...
 * @type {[RegExp, string[]][]}
 */
export const response_patterns: [RegExp, string[]][] = [
	[
		/^(.*)我(需要|想要|想|要|希望)(.*)$/,
		[
			"你为什么{1}{2}?",
 ...
 * * 状态效果类型
 */
const effect_map = new Map<string, string>(
	[
